/* === D:\SmartIASystems\bank-correspondent-service\eslint.config.js === */
// eslint.config.js
export default [
  {
...
/* === D:\SmartIASystems\bank-correspondent-service\vitest.config.js === */
// vitest.config.js
...
/* === D:\SmartIASystems\bank-correspondent-service\coverage\lcov-report\block-navigation.js === */
/* eslint-disable */
...
/* === D:\SmartIASystems\bank-correspondent-service\coverage\lcov-report\prettify.js === */
/* eslint-disable */
...
/* === D:\SmartIASystems\bank-correspondent-service\coverage\lcov-report\sorter.js === */
/* eslint-disable */
...
/* === D:\SmartIASystems\bank-correspondent-service\src\index.js === */
// src/index.js
...
import bankCorrespondentRoutes from './routes/bankCorrespondentRoutes.js';
...
// Inicialização real (não executa em test)
...
/* === D:\SmartIASystems\bank-correspondent-service\src\config\config.js === */
...
/* === D:\SmartIASystems\bank-correspondent-service\src\config\database.js === */
...
/* === D:\SmartIASystems\bank-correspondent-service\src\config\logger.js === */
...
/* === D:\SmartIASystems\bank-correspondent-service\src\controllers\bankCorrespondentController.js === */
...
function readScope(req) {
  ...
  return { scope, isAll: scope === 'all' };
}

export async function getBankCorrespondents(req, res) {
  try {
    const { scope, isAll } = readScope(req);
    const q = {};
...
/* === D:\SmartIASystems\bank-correspondent-service\src\middlewares\authorizeAccessAdmin.js === */
...
/* === D:\SmartIASystems\bank-correspondent-service\src\middlewares\authorizeAccessUser.js === */
...
/* === D:\SmartIASystems\bank-correspondent-service\src\middlewares\authorizeGroupResource.js === */
...
/* === D:\SmartIASystems\bank-correspondent-service\src\models\bankCorrespondent.model.js === */
import mongoose from 'mongoose';
...
/* === D:\SmartIASystems\bank-correspondent-service\src\models\GroupResourceGrant.js === */
...
/* === D:\SmartIASystems\bank-correspondent-service\src\routes\bankCorrespondentRoutes.js === */
...
} from '../controllers/bankCorrespondentController.js';

const router = Router();
const APP_RESOURCE_NAME = process.env.APP_RESOURCE_NAME || 'bank-correspondent';
